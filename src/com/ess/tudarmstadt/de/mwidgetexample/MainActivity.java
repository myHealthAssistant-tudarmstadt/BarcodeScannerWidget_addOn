...
public class MainActivity extends ActionBarActivity implements
	...
	public void onTitleEditorCallbackListener(int token, final JSONObject key) {
		...
		if (token == TitleEditorFragment._SAVE) {
			if (commUnit != null) {
				if (progressDialog != null)
					progressDialog.show();
		...
		} else if (token == TitleEditorFragment._EDIT) {
			if (commUnit != null) {
	...
	public void onPhotoListItemClickListener(int id, String title,
		...
		openEditor(id, title, content, longitude, latitude, objUri);

	}

	/** Open the title editor fragment **/
	private void openEditor(int id, String title, String content,
			double longitude, double latitude, String objUri) {
